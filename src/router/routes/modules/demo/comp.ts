...
const comp: AppRouteModule = {
  ...
  children: [
...

    {
      ...
      children: [
        ...
        },
        {
          path: 'form01',
          name: 'formdemo',
          component: () => import('/@/views/demo/devextreme/form/formdemo01.vue'),
          meta: {
            title: t('重置表单'),
          },
        },
    ...
    {
      path: 'devextremeprint',
      name: 'devextremeprintDemo',
      redirect: '/comp/devextremeprint/basic',
      component: getParentLayout('devextremeprintDemo'),
      meta: {
        // icon: 'mdi:form-select',
        title: t('routes.demo.devextremeprint.devextremeprintmanage'),
      },
      children: [
        {
          path: 'devextremeprintds',
          name: 'devextremeprintds',
          component: () => import('/@/views/demo/devextremeprint/devextremeprintds/index.vue'),
          meta: {
            title: t('routes.demo.devextremeprint.devextremeprintds'),
          },
        },
        {
          path: 'devextremeprintylOne',
          name: 'devextremeprintylOne',
          component: () => import('/@/views/demo/devextremeprint/devextremeprintyl/printyl.vue'),
          meta: {
            title: t('routes.demo.devextremeprint.devextremeprintyl'),
          },
        },
      ],
    },
